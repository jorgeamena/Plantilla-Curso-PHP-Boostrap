...
abstract class Validador {
    ...
    protected function validar_titulo ($conexion, $titulo) {
        ...
        if (strlen($titulo) > 255) {
            return "El titulo no puede ocupar más de 255 caractéres.";
        }
        ...
        if (RepositorioComentario::titulo_existe($conexion, $titulo)) {
            return "Ya existe un comentario con ese título, por favor escoge uno diferente.";
        }
    }
    ...
    protected function validar_url ($conexion, $url) {
        ...
        if (strlen($url) != strlen(trim($url_tratada))) {
            return "El url no puede contener espacios en blanco.";
        }
 
        if (RepositorioEntrada::url_existe($conexion, $url)) {
            return "Ya existe una entrada con esa url, por favor escoga una diferente.";
        }
    }
