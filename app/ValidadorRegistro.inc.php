...
class ValidadorRegistro {
    ...
    private function validar_nombre($conexion, $nombre) {
        ...
        if(strlen($nombre) < 6) {
            return "El nombre debe ser de mas de 6 caracteres.";
        }

        if(strlen($nombre) > 32) {
            return "El nombre debe ser de menor de 32 caracteres.";
        }
    ...
    private function validar_email($conexion, $email) {
        ...
        if(RepositorioUsuario :: email_existe($conexion, $email)) {
            return "Este email ya esta en uso. Por favor, prueba otro email o <a href='#'>Intente recuperar su contraseña</a>.";
        }
